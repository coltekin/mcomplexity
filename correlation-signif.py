...
exclude = {'cmn', 'jpn', 'kor_gsd', 'kor_kai', 'lat_itt'}
...
print(r"\begin{tabular}{l*{" + str(len(mlist)) +
        r"}{S[table-format=0.4,round-precision=4,table-omit-exponent=true,scientific-notation=false]}}")
